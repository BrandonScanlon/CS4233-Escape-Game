...
public class EscapeGameManagerTest {
  ...
  void makeGameObject() {
    ...
    try{
      egm = new EscapeGameBuilder("configurations/escape game configurations/EscapeGameTests.egc").makeGameManager();
    } catch (Exception e){
      e.printStackTrace();
  ...
  void makeFullGameObject() {
    ...
    try{
      egm = (EscapeGameManagerImpl)new EscapeGameBuilder("configurations/escape game configurations/EscapeGameTests.egc").makeGameManager();
    } catch (Exception e){
      e.printStackTrace();
      fail("Exception from escape builder: " + e.getMessage());
    }
...
//    EscapeGameManager egm = null;
//    try{
//      egm = new EscapeGameBuilder("configurations/EscapeGameTests2.egc").makeGameManager();
//    } catch (Exception e){
//      e.printStackTrace();
//      fail("Exception from escape builder: " + e.getMessage());
//    }
...
//    EscapeGameManagerImpl egm = null;
//    try{
//      egm = (EscapeGameManagerImpl)new EscapeGameBuilder("configurations/EscapeGameTests2.egc").makeGameManager();
//    } catch (Exception e){
//      fail("Exception from escape builder: " + e.getMessage());
//    }
//    assertNotNull(egm);
...
//    EscapeGameManagerImpl egm = null;
//    try{
//      egm = (EscapeGameManagerImpl)new EscapeGameBuilder("configurations/EscapeGameTests3.egc").makeGameManager();
//    } catch (Exception e){
//      fail("Exception from escape builder: " + e.getMessage());
//    }
//    assertNotNull(egm);
...
//  }
  ...
  void checkBoardInfinite() {
    EscapeGameManagerImpl egm = null;
    try{
      egm = (EscapeGameManagerImpl)new EscapeGameBuilder("configurations/escape game configurations/EscapeGameTests4.egc").makeGameManager();
    } catch (Exception e){
      e.printStackTrace();
      fail("Exception from escape builder: " + e.getMessage());
    }
...
//  }
  ...
  void checkSQUAREMoveToSameCoordinate() {
    EscapeGameManagerImpl egm = null;
    try{
      egm = (EscapeGameManagerImpl)new EscapeGameBuilder("configurations/escape game configurations/EscapeGameTests3.egc").makeGameManager();
    } catch (Exception e){
      fail("Exception from escape builder: " + e.getMessage());
    }
    assertNotNull(egm);
